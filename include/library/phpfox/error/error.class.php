...
class Phpfox_Error
{
	...
	*/
	/**
	 * Đây là phần hiển thị thông báo
	 *
	 * @static 
	 * @param string $sXml XML code to parse
	 * @return string New string without CDATA
	 */
	public static function displayMsg($sMessage, $sClass = 'warning'){
		echo '<p class="'.$sClass.'" style="padding: 10px;">'.$sMessage.'</p>';
		echo '<script type="text/javascript">$Core.hideLoadding();</script>';
		return false;
	}
	/*
