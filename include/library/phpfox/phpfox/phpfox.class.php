...
{	
	...
	{
		$aOut = array(
			'plugin/bootstrap.min.css'                  => 'style_css',
			'plugin/font-awesome.css'                   => 'style_css',
			'plugin/ionicons.min.css'                   => 'style_css',
			'plugin/AdminLTE.css'                       => 'style_css',
			'plugin/skin-green.css'                     => 'style_css',
			// 'plugin/_all-skins.min.css'                 => 'style_css',
			'plugin/dataTables.bootstrap.css'           => 'style_css',			
			...
			'plugin/jquery-2.2.3.min.js'                => 'style_script',
			'plugin/jquery-ui.js'                       => 'style_script',
			
			
			'plugin/bootstrap.min.js'                   => 'style_script',
			// 'plugin/fastclick.js'                       => 'style_script',
			// 'plugin/jquery.sparkline.min.js'            => 'style_script',
			// 'plugin/jquery-jvectormap-1.2.2.min.js'     => 'style_script',
			// 'plugin/jquery-jvectormap-world-mill-en.js' => 'style_script',
			'plugin/jquery.slimscroll.min.js'           => 'style_script',
			// 'plugin/Chart.min.js'                       => 'style_script',
			// 'plugin/demo.js'                            => 'style_script',
			// 'plugin/icheck.min.js'                      => 'style_script',
			'plugin/app.js'                             => 'style_script',
